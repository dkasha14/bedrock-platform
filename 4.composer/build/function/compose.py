...
ARTIFACTS_BUCKET = os.environ.get("ARTIFACTS_BUCKET", "dlr-iac-rag-prod-artifacts")
...
def call_retriever(ask: str, constraints: dict):
    ...
    response = lambda_client.invoke(
        FunctionName="dlr-iac-rag-prod-retrieve-v2",
...
def load_org_policy():
    ...
    param = ssm.get_parameter(Name="/dlr-iac-rag-prod/org-policy", WithDecryption=True)
